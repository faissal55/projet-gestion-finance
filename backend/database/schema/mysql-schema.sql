...
CREATE TABLE `alerts` (
  ...
  `type` enum('budget','tresorerie','facture','dette') NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `alerts_user_id_is_read_index` (`user_id`,`is_read`),
  KEY `alerts_user_id_severity_index` (`user_id`,`severity`),
...
CREATE TABLE `debts` (
  ...
  `status` enum('active','payee') NOT NULL DEFAULT 'active',
  `description` text DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `debts_user_id_status_index` (`user_id`,`status`),
  KEY `debts_user_id_due_date_index` (`user_id`,`due_date`),
...
CREATE TABLE `invoices` (
  ...
  `amount` decimal(15,2) NOT NULL,
  `due_date` date NOT NULL,
  `status` enum('en_attente','payee','en_retard') NOT NULL DEFAULT 'en_attente',
  `description` text DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `invoices_user_id_status_index` (`user_id`,`status`),
  KEY `invoices_user_id_due_date_index` (`user_id`,`due_date`),
